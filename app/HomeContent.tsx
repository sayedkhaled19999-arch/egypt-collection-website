    ...
    <div className="bg-[#F4F4F4] text-[#353535]" dir="rtl">
      ...
      <section className="relative bg-[#2563EB] text-white">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-[#F4F4F4] leading-relaxed animate-fade-down delay-150">
            نحن نبني المستقبل معاً من خلال الابتكار والتميز في تقديم الحلول
          </p>
          <div className="flex justify-center">
            <Link
              href="/jobs"
              className="inline-block bg-white text-[#2563EB] px-8 py-4 rounded-lg font-bold text-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-[#e0e0e0]"
            >
      ...
      <section className="py-20 bg-[#F4F4F4] text-center">
        <div className="container mx-auto px-4">
          ...
          <Link
            href="/jobs"
            className="inline-block bg-[#2563EB] text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-[#1e4db7] transition-colors shadow-lg"
          >
            قدّم على وظيفة
          </Link>
        </div>
